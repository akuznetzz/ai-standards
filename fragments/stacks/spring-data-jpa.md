...
- Use DTOs or projections for transport and read models; keep JPA entities out of public API contracts by default.
...
- Use derived queries, JPQL, Criteria, or native SQL deliberately based on query shape, clarity, and correctness.
- Keep write transactions explicit for multi-step mutations, and make locking choices visible when consistency depends on them.
